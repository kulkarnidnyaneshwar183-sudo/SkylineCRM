...
<%@ page import="java.util.List, com.crm.Expense" %>
<%
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="expenseDate" class="form-control" value="<%= new java.sql.Date(System.currentTimeMillis()) %>" required>
                            </div>
                        </div>
                        <div class="mb-0">
